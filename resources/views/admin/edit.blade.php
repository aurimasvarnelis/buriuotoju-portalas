...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-6">     
            <div class="card">
                <div class="card-header">{{ __('Redaguoti vartotoją:') }} "{{ $user->name }}" 
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.update', $user->id) }}" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="password" value="" type="password" class="form-control @error('password') is-invalid @enderror" name="password" value="{{ old('password') }}" autocomplete="password">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select id="role" value="{{ $user['role'] }}" type="role" class="form-control @error('role') is-invalid @enderror" name="role" value="{{ old('role') }}" autocomplete="role">
                                        @if($user['role'] == "user")
                                            <option value="user" selected="true">Vartotojas</option>
                                        ...
                                        @if($user['role'] == "moderator")
                                            ...
                                            <option value="moderator" selected="true">Valdytojas</option>
                                            <option value="admin">Administratorius</option>
                                        @endif
                                        ...
                                        @if($user['role'] == "admin")
                                            <option value="user">Vartotojas</option>
                                            <option value="moderator">Valdytojas</option>
                                            <option value="admin" selected="true">Administratorius</option>
                                        @endif
                                    </select>
